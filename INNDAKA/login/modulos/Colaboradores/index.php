        ...
        <form action="guardar_informacion.php" method="post" class="col-Form2" id="formulario1"
            ...
            <div class="col-datos-personales">
                ...
                <div id="col-Tel-Cuenta">
                    ...
                    <div class="input-with-label">
                        <label for="col-Input-Correo">Correo Personal</label>
            ...
            <div class="col-Div-Datos-Laborales">
                ...
                <div class="col-Div-Datos-Lab-3">
                    <div class="input-with-label">
                        <label for="col-Input-Fecha-Firma-Inicial">Fecha de alta</label>
                    ...
                    <div class="input-with-label">
                        <label for="col-Input-Fecha-Firma-Final">Fecha de baja</label>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (datosString) {
        ...
        document.getElementById("col-Input-Estado-Contratacion").value = datos.estado_contratacion;
