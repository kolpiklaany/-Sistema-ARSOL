...
<body>
    ...
    <button class="modal-btn" onclick="toggleModal()">Soy un modal</button>
                    ...
                    <div class="rum-Datos-Generales-Dividir">
                        ...
                        <div class="rum-Div-Datos-Generales-Centro">
                            ...
                            <div class="rum-Div-Contenido-3">
                                ...
                                <input type="date" name="rum-fecha" id="rum-Input-Fecha" placeholder="Ej. 12/12/1993" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="rum-Datos-Maquina-Vehiculos-Dividir">
                        ...
                        <div class="rum-Div-Datos-Maquina-Vehiculo-Centro">
                            ...
                            <div class="rum-Div-Contenido-5">
                                ...
                                <input type="text" name="rum-tipo" id="rum-Input-Tipo" placeholder="Ej. Gr&uacute;a" readonly>
                            </div>
                            <div class="rum-Div-Contenido-6">
                                <label for="">Modelo</label>
                                <input type="text" name="rum-modelo" id="rum-Input-Modelo" placeholder="Ej. Modelo" readonly>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="rum-Div-Control-Actividades-Horas-Campo">
            <div class="rum-Control-Actividades-Horas-Campo-Dividir">
                ...
                <table>
                    ...
                    <tbody>
                    <?php include 'mostrar_info.php'; ?>
             <!--            <tr>
                            <td>1</td>
                            <td><?php echo $descripcion_actividad;?></td>
                            <td><?php echo $inicio_trabajo;?></td>
                            <td><?php echo $fin_trabajo;?></td>
                            <td>
                    ...
                    <td><?php echo $horas_efectivas;?></td>
...
<div class="modal-overlay" id="modalOverlay">
    <div class="modal">
        ...
        <!-- Contenido del formulario en la ventana modal -->
        <form id="miFormulario" onsubmit="enviarFormulario(event)">
